...
#include <stdio.h>
/**
 * open_file - Opens a file a function.
 * @file_name: String with the name of file.
 */
...
/**
 * interpret_line - Separate each line into tokens to determine
 * the function to call.
 * @lineptr: String representing the line in a file.
 * @line_number: Line number for the opcode to run.
...
/**
 * find_func - Find the appropite functions to run the opcode instructions.
 * @opcode: The operation code, can be push, pall, ...
...
/**
 * call_fun - Calls the required function to run.
 * @f: Pointer to the function that is to about to be called.
